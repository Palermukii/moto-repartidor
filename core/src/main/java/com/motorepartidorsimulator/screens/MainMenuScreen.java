package com.motorepartidorsimulator.screens;
...
import com.motorepartidorsimulator.Juego;
...
public class MainMenuScreen implements Screen {
    ...
    public void show() {
        ...
        try {
            backgroundMusic = Gdx.audio.newMusic(Gdx.files.internal("audio/song.mp3")); // Ruta a tu archivo song.mp3
